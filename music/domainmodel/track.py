...
class Track:
    ...
    @property
    def video_hyperlink(self):
        return self.__video_hyperlink

    @video_hyperlink.setter
    def video_hyperlink(self, link):
        if isinstance(link, str):
            self.__video_hyperlink = link
        else:
            self.__video_hyperlink = None
