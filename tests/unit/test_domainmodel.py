...
class TestReview:
    ...
    def test_construction(self):
        ...
        user1 = User('123','12345678')
        review1 = Review(track1, user1, 3)
        ...
        with pytest.raises(ValueError):
            Review(track1, user1, 'rating')

        # Negative value of comment raises error
        with pytest.raises(ValueError):
            Review(track1, user1, -5)
        # Rating value > 5 raises error
        with pytest.raises(ValueError):
            Review(track1, user1, 10)
    ...
    def test_equality(self):
        ...
        user1 = User('123','12345678')
        review1 = Review(track1, user1, 2)
        review3 = Review(track1, user1, 5)
        review5 = Review(None, user1, 2)
